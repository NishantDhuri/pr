...
try:
    diabetes_model = pickle.load(open(r'D:\Nishant\Multiple_Disease_Pred\diabetes.pkl', 'rb'))
    heart_disease_model = pickle.load(open(r'D:\Nishant\Multiple_Disease_Pred\heart.pkl', 'rb'))
    # kidney_disease_model = pickle.load(open(r'D:\Nishant\Multiple_Disease_Pred\kidney.pkl', 'rb'))
